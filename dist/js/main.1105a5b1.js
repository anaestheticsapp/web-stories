...
async function webShare(url, opts = {}) {
...
const stories = [
  [
    { url: 'https://stories.anaesthetics.app/assets/stories/au-8.webp', text: 'Merry Christmas!', class: 'text' },
    { url: 'https://stories.anaesthetics.app/assets/stories/au-7.webp' },
    { url: 'https://stories.anaesthetics.app/assets/stories/au-6.webp' },
    { url: 'https://stories.anaesthetics.app/assets/stories/au-5.webp' },
    { url: 'https://stories.anaesthetics.app/assets/stories/au-4.webp', text: 'Hunter Valley', class: 'h1' },
    { url: 'https://stories.anaesthetics.app/assets/stories/au-3.webp' },
    { url: 'https://stories.anaesthetics.app/assets/stories/au-2.webp' },
    { url: 'https://stories.anaesthetics.app/assets/stories/au-1.webp', text: 'Australia', class: 'label' },
  ],
  [
    { url: 'https://stories.anaesthetics.app/assets/stories/sp-4.webp' },
    { url: 'https://stories.anaesthetics.app/assets/stories/sp-3.webp' },
    { url: 'https://stories.anaesthetics.app/assets/stories/sp-2.webp' },
    { url: 'https://stories.anaesthetics.app/assets/stories/sp-1.webp', text: 'Scafell Pike', class: 'label' },
  ],
  [
    { url: 'https://stories.anaesthetics.app/assets/stories/gc-4.webp' },
    { url: 'https://stories.anaesthetics.app/assets/stories/gc-3.webp' },
    { url: 'https://stories.anaesthetics.app/assets/stories/gc-2.webp', text: 'Grand Canyon', class: 'h1' },
    { url: 'https://stories.anaesthetics.app/assets/stories/gc-1.webp', text: 'Hoover Dam', class: 'label' },
  ],
  [
    { url: 'https://stories.anaesthetics.app/assets/stories/manc-2.webp' },
    { url: 'https://stories.anaesthetics.app/assets/stories/manc-1.webp', text: 'Manchester', class: 'label' },
  ],
  [
    { url: 'https://stories.anaesthetics.app/assets/stories/san-4.webp' },
    { url: 'https://stories.anaesthetics.app/assets/stories/san-3.webp' },
    { url: 'https://stories.anaesthetics.app/assets/stories/san-2.webp' },
    { url: 'https://stories.anaesthetics.app/assets/stories/san-1.webp', text: 'San Francisco', class: 'label' },
  ],
  [
    { url: 'https://stories.anaesthetics.app/assets/stories/van-6.webp' },
    { url: 'https://stories.anaesthetics.app/assets/stories/van-5.webp' },
    { url: 'https://stories.anaesthetics.app/assets/stories/van-4.webp' },
    { url: 'https://stories.anaesthetics.app/assets/stories/van-3.webp' },
    { url: 'https://stories.anaesthetics.app/assets/stories/van-2.webp' },
    { url: 'https://stories.anaesthetics.app/assets/stories/van-1.webp', text: 'Vancouver', class: 'label' },
  ],
  [
    { url: 'https://stories.anaesthetics.app/assets/stories/yp-3.webp' },
    { url: 'https://stories.anaesthetics.app/assets/stories/yp-2.webp' },
    { url: 'https://stories.anaesthetics.app/assets/stories/yp-1.webp', text: 'Yosemite', class: 'label' },
  ],
];
...
class StoriesView extends LitElement {
  ...
  _endOfStories(direction, user) {
    ...
    const el = section.appendChild(create('article', { className: 'end ' + direction }));
...
(async function loadMaterialIcons() {
  await import('./svg-icon-16d05eb6.js');
}());
